...
#### [ПОДРОБНЕЕ О AutoRussifier](docs/AutoRussifier.md)
...
- Во многих местах отсутствует перевод на русский:
	- Возможное решение этой проблемы можно найти на [**Boosty**](https://boosty.to/dog729).
...
* [Dontaz](https://github.com/Dontaz) - 🐱 Публикация, Редактирование публичных материалов
* [neewb20221](https://github.com/neewb20221) - Ручная редактура
* [Claymore0098](https://github.com/Kirito0098) - Самый большой вклад по нейропереводу(GROK) для черновика.
